        ...
        <aside className="w-full lg:w-1/5 mb-auto bg-blue-100 border border-blue-300 rounded-xl shadow-md p-4">
          <div className="space-y-2 text-sm">
            ...
            <div className="flex flex-col mt-3 space-y-5">
              <a href="https://animekai.to/watch/kaoru-hana-wa-rin-to-saku-n109" target="_blank" rel="noopener noreferrer">
              ...
              <a href="https://animekai.to/watch/dan-da-dan-season-2-8lk0" target="_blank" rel="noopener noreferrer">
              ...
              <a href="https://animekai.to/watch/one-piece-dk6r" target="_blank" rel="noopener noreferrer">
